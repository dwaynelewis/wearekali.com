...
// -------------------------------------------------------------
    ...
    (function () {
        ...
        $('.chart_one').easyPieChart({
            ...
            delay: 3000,
            barColor: '#ce5050',
            trackColor: 'rgba(255,255,255,0.01)',
            scaleColor: false,
            lineWidth: 7,
            size: 175,
            scaleLength: 1,
...
$('.portfolio-action-btn').magnificPopup({
...
//-------------------------------------------------------
  ...
  $('.awards-counter-section').bind('inview', function(event, visible, visiblePartX, visiblePartY) {
                if (visible) {
...
$('.hello_testi_slider_wrapper .owl-carousel').owlCarousel({
                loop: true,
                margin: 10,
				autoplay:true,
                responsiveClass: true,
