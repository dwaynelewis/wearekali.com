...
$(document).ready(function () {
    ...
    $(window).scroll(function () {
        if ($(this).scrollTop() > 150) {
            ...
            $('.floating-cta').addClass('opacity-1');
        }
        else {
            $('.scroll-top-arrow').fadeOut('slow');
            $('.floating-cta').removeClass('opacity-1');
    ...
    $(document).on("click", '#project-contact-us-button', function (e) {
        e.preventDefault();
        var isValid = ValidationProjectContactForm();

        if (isValid) {
            $("#project-contact-us-button").hide('slow');
            $.ajax({
                type: "POST",
                url: "https://kali-email-app.herokuapp.com/api/send",
                ...
                success: function (result) {
                    ...
                    $("#success-project-contact-form").html("Thanks for your message.");
